...
export async function POST(r) {
  try {
    ...
    await prisma.$executeRawUnsafe("INSERT INTO tenkhah_requests (request_number,request_date,project_id,requested_amount,currency,unregistered_balance,unsettled_balance,created_by_id,project_manager_id,current_assignee_user_id) VALUES ($1,$2,$3,$4::bigint,$5,$6::bigint,$7::bigint,$8,$9,$9)", String(b.requestNumber).trim(), String(b.requestDate), pid, String(w), String(b.currency || ""), String(w), String(w), uid, mid);
    return json({ ok: true }, 201);
  } catch (e) { return json({ error: "internal_error", message: String(e?.message || e) }, 500); }
}
